...
export const CaseListItem: React.FC<CaseListItemProps> = ({ caseData, isSelected, onClick }) => (
  ...
  >
    {/* Avatar/Initials */}
    <div className={`w-9 h-9 rounded-full flex-shrink-0 flex items-center justify-center text-blue font-medium text-sm bg-slate-500`}>
      pjjonsdfliwenbqiowuenbikwjedn
    </div>
    {/* Name and Details */}
